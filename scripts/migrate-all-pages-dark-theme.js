...
// Pages to migrate to dark theme
const pagesToMigrate = [
  'upload/page.tsx',
  'templates/page.tsx',
  'cover-letter/page.tsx',
  'interview-prep/page.tsx',
  'skills-assessment/page.tsx',
  'landing/page.tsx',
  'help/page.tsx',
  'history/page.tsx',
  'roast-cv/page.tsx',
  'cv-examples/page.tsx',
  'cv-writing-guide/page.tsx',
  'ats-optimization-guide/page.tsx',
  'pricing-comparison/page.tsx',
...
console.log('🎨 Starting dark theme migration for all pages...\n');
...
pagesToMigrate.forEach(pagePath => {
  ...
  try {
    ...
    if (changeCount > 0) {
      ...
      console.log(`✅ Updated: ${pagePath} (${changeCount} changes)`);
      totalUpdated++;
