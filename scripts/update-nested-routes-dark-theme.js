...
// Nested route files to update
const filesToUpdate = [
  'skills-assessment/results/[id]/page.tsx',
  'skills-assessment/take/[id]/page.tsx',
  'interview-prep/content.tsx',
  'interview-prep/layout.tsx',
  'interview-prep/view/[id]/page.tsx',
  'career-coach/page.tsx'
];

// Comprehensive dark theme replacements
const replacements = [
  // Main backgrounds
  ...
  { from: /className="bg-gray-50 min-h-screen"/g, to: 'className="bg-black text-white min-h-screen"' },
  { from: /className="bg-white min-h-screen"/g, to: 'className="bg-black text-white min-h-screen"' },
  ...
  { from: /className="bg-white sticky top-0"/g, to: 'className="bg-black border-b border-white/10 sticky top-0 backdrop-blur-md"' },
  
  // Back/navigation links
  { from: /className="([^"]*?)text-gray-600 hover:text-gray-900/g, to: 'className="$1text-gray-400 hover:text-white transition-colors' },
  { from: /className="([^"]*?)text-gray-700 hover:text-gray-900/g, to: 'className="$1text-gray-300 hover:text-white transition-colors' },
  ...
  { from: /className="bg-white shadow rounded-lg p-6"/g, to: 'className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6"' },
  { from: /className="bg-white rounded-lg p-4"/g, to: 'className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4"' },
  { from: /className="bg-white p-6 rounded-lg"/g, to: 'className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl"' },
  
  // Headings
  { from: /className="text-4xl font-bold text-gray-900/g, to: 'className="text-5xl font-black text-white' },
  ...
  { from: /bg-white([^/])/g, to: 'bg-white/5 backdrop-blur-md border border-white/10$1' },
  ...
  { from: /className="([^"]*?)bg-purple-600([^"]*?)text-white([^"]*?)rounded-lg/g, to: 'className="$1bg-white$2text-black$3rounded-full font-black' },
...
console.log('🎨 Updating nested routes to dark theme...\n');
