    ...
    try {
      ...
      if (error) {
        ...
        if (needsConfirmation) {
          ...
          toast.success('Account created successfully! Welcome to My CV Buddy.')
              ...
              {password.length > 0 && (() => {
                ...
                return (
                  <div className="mt-2">
                    ...
                    <p className="text-xs text-gray-400">Password strength: <span className="font-semibold text-white">{strength.label}</span></p>
                  </div>
                )
              })()}
            </div>
