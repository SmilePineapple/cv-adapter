      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 rounded-full text-purple-700 text-sm font-medium mb-6">
            ...
            Optimiert für deutsche Lebensläufe
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Verwandeln Sie Ihren Lebenslauf mit KI
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Passen Sie Ihren Lebenslauf sofort an jede Stellenanzeige an. 
            Unsere KI erstellt professionelle Inhalte auf Deutsch, optimiert für ATS-Systeme.
          </p>
          ...
          <p className="text-sm text-gray-500">
            ✨ 1 kostenlose Generierung • Keine Kreditkarte erforderlich
          </p>
        </div>
      </section>
