...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Comprehensive list of ATS keywords to help your CV get past automated screening systems.',
    type: 'article',
  }
}

export default function CVKeywordsForATS() {
  return (
    <div className="">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
          CV Keywords for ATS: Complete List for UK Jobs (2025)
        </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-blue-900/20 border-l-4 border-blue-600 p-6 my-8">
            <p className="text-blue-300 font-semibold mb-2">💡 Quick Tip</p>
            <p className="text-blue-200">
              Don't just copy-paste keywords! Use them naturally in context. ATS systems check for keyword stuffing and will penalize your CV.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white border border-white/20 rounded-lg p-4">
              <h4 className="font-bold text-white mb-3">Action Verbs</h4>
              <div className="flex flex-wrap gap-2">
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Achieved</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Managed</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Developed</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Implemented</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Led</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm">Delivered</span>
              </div>
            </div>
            <div className="bg-white border border-white/20 rounded-lg p-4">
              <h4 className="font-bold text-white mb-3">Soft Skills</h4>
              <div className="flex flex-wrap gap-2">
                <span className="bg-blue-900/30 text-blue-200 px-2 py-1 rounded text-sm">Leadership</span>
                <span className="bg-blue-900/30 text-blue-200 px-2 py-1 rounded text-sm">Communication</span>
                <span className="bg-blue-900/30 text-blue-200 px-2 py-1 rounded text-sm">Problem-solving</span>
                <span className="bg-blue-900/30 text-blue-200 px-2 py-1 rounded text-sm">Teamwork</span>
                <span className="bg-blue-900/30 text-blue-200 px-2 py-1 rounded text-sm">Time management</span>
              </div>
            </div>
            <div className="bg-white border border-white/20 rounded-lg p-4">
              <h4 className="font-bold text-white mb-3">Certifications</h4>
              <div className="flex flex-wrap gap-2">
                <span className="bg-green-900/30 text-green-200 px-2 py-1 rounded text-sm">BSc/BA/MSc/MBA</span>
                <span className="bg-green-900/30 text-green-200 px-2 py-1 rounded text-sm">CIPD</span>
                <span className="bg-green-900/30 text-green-200 px-2 py-1 rounded text-sm">PMP</span>
                <span className="bg-green-900/30 text-green-200 px-2 py-1 rounded text-sm">PRINCE2</span>
              </div>
            </div>
          </div>
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Technology & IT</h3>
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Marketing & Digital</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Finance & Accounting</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Human Resources</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Sales & Business Development</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Project Management</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Healthcare & Nursing</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-slate-300 mt-8 mb-3">Education & Teaching</h3>
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-green-900/20 border-l-4 border-green-600 p-4">
              <h4 className="text-green-300 font-semibold mb-2">✅ DO: Mirror Job Description Language</h4>
              <p className="text-green-200">
                If the job says "stakeholder engagement," use that exact phrase instead of "working with stakeholders."
              </p>
            </div>

            <div className="bg-green-900/20 border-l-4 border-green-600 p-4">
              <h4 className="text-green-300 font-semibold mb-2">✅ DO: Use Keywords in Context</h4>
              <p className="text-green-200">
                "Managed £500K budget using SAP" is better than just listing "Budget Management, SAP" in skills section.
              </p>
            </div>

            <div className="bg-green-900/20 border-l-4 border-green-600 p-4">
              <h4 className="text-green-300 font-semibold mb-2">✅ DO: Include Acronyms AND Full Terms</h4>
              <p className="text-green-200">
                "Search Engine Optimization (SEO)" covers both variations that ATS might search for.
              </p>
            </div>

            <div className="bg-red-900/20 border-l-4 border-red-600 p-4">
              <h4 className="text-red-300 font-semibold mb-2">❌ DON'T: Keyword Stuff</h4>
              <p className="text-red-200">
                Don't create a "keyword dump" section or repeat keywords unnaturally. ATS systems detect this.
              </p>
            </div>

            <div className="bg-red-900/20 border-l-4 border-red-600 p-4">
              <h4 className="text-red-300 font-semibold mb-2">❌ DON'T: Use Synonyms When Job Uses Specific Terms</h4>
              <p className="text-red-200">
                If job says "JavaScript," don't write "JS." Use the exact term from the job description.
              </p>
            </div>
          </div>
