        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border-l-4 border-blue-500">
            ...
            <div className="bg-red-900/20 rounded p-4">
              <p className="text-red-300 font-semibold mb-2">❌ Don't Include:</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border-l-4 border-purple-500">
            ...
            <div className="bg-purple-900/20 rounded p-4 mb-4">
            ...
            <div className="bg-red-900/20 rounded p-4">
              <p className="text-red-300 font-semibold mb-2">❌ Bad Example:</p>
              ...
              <p className="text-red-200 text-xs mt-2">Too vague, no numbers, focuses on responsibilities not achievements</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border-l-4 border-orange-500">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-4">
              <div>
                <p className="font-semibold text-white mb-2">For Graduates (0-3 years):</p>
              ...
              <div>
                <p className="font-semibold text-white mb-2">For Experienced (5+ years):</p>
                <ul className="text-gray-300 text-sm space-y-1">
                  <li>• Degree classification and subject</li>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white border border-white/20 rounded-lg p-6">
              ...
              <p className="text-red-400 text-xs mt-2">❌ Skip: "Reading, watching TV, socializing"</p>
            </div>
          </div>
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-6 mb-8">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Photo</p>
                <p className="text-red-200 text-sm">UK CVs don't include photos (unless acting/modeling). It can lead to unconscious bias.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Date of Birth / Age</p>
                <p className="text-red-200 text-sm">Protected by age discrimination laws. Never include your age or DOB.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Marital Status / Children</p>
                <p className="text-red-200 text-sm">Personal information that's irrelevant to your ability to do the job.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ National Insurance Number</p>
                <p className="text-red-200 text-sm">Only provide this after you're hired, not on your CV.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Salary Expectations</p>
                <p className="text-red-200 text-sm">Discuss salary during interviews, not on your CV.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ "References Available Upon Request"</p>
                <p className="text-red-200 text-sm">This is assumed. Don't waste space stating the obvious.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Reasons for Leaving Jobs</p>
                <p className="text-red-200 text-sm">Save this for interviews if asked. Don't explain on your CV.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Irrelevant Work Experience</p>
                <p className="text-red-200 text-sm">Jobs from 15+ years ago or completely unrelated roles can be omitted.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Generic Hobbies</p>
                <p className="text-red-200 text-sm">"Reading, watching films, socializing" add no value. Either make them specific or remove them.</p>
              </div>
              <div>
                <p className="text-red-300 font-semibold mb-1">❌ Lies or Exaggerations</p>
                <p className="text-red-200 text-sm">Employers verify qualifications and references. Be honest.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <h3 className="font-bold text-white mb-4">Detail Level by Experience:</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Graduate / Entry-Level (0-3 years)</h4>
              ...
              <div className="flex items-start">
                <div className="bg-blue-900/30 rounded-full p-2 mr-4 flex-shrink-0">
                  <span className="text-blue-400 font-bold text-sm">3-10</span>
                </div>
                <div>
                  <h4 className="font-bold text-white mb-2">Mid-Level (3-10 years)</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Senior (10+ years)</h4>
          ...
          <div className="bg-gray-100 rounded-lg p-6 mb-8">
            <h3 className="font-bold text-white mb-4">Before Submitting, Check:</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="font-semibold text-white mb-3">✅ Must Have:</p>
              ...
              <div>
                <p className="font-semibold text-white mb-3">❌ Must NOT Have:</p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <AlertCircle className="w-4 h-4 text-red-400 mr-2 mt-1 flex-shrink-0" />
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <h3 className="font-bold text-white mb-4">How to Tailor:</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="bg-blue-900/30 rounded-full p-2 mr-4 flex-shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Read Job Description Carefully</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Match Keywords</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Reorder Bullet Points</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Adjust Skills Section</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Customize Professional Summary</h4>
          ...
          <div className="border-t border-white/20 pt-8 mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/professional-cv-how-to-create" className="block bg-white border border-white/20 rounded-lg p-6 hover:shadow-lg transition">
                <h4 className="font-bold text-white mb-2">Professional CV: How to Create One</h4>
                <p className="text-gray-400 text-sm">Complete guide to creating a professional CV</p>
              </Link>
              <Link href="/blog/cv-examples-by-industry-uk" className="block bg-white border border-white/20 rounded-lg p-6 hover:shadow-lg transition">
                <h4 className="font-bold text-white mb-2">CV Examples by Industry</h4>
