...
import { ArrowLeft, Sparkles, CheckCircle, TrendingUp, Target, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-4xl font-black text-white mt-12 mb-6">What is an AI CV Generator?</h2>
          ...
          <h2 className="text-4xl font-black text-white mt-12 mb-6">How AI CV Generators Work</h2>
          ...
          <h2 className="text-4xl font-black text-white mt-12 mb-6">Best Practices for AI CV Generation</h2>
          
          <h3 className="text-3xl font-black text-white mt-8 mb-4">1. Start with a Complete Base CV</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-3xl font-black text-white mt-8 mb-4">2. Use the Full Job Description</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-3xl font-black text-white mt-8 mb-4">3. Review and Personalize</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h2 className="text-4xl font-black text-white mt-12 mb-6">The Future of AI in Job Applications</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
            As AI technology advances, we're seeing increasingly sophisticated features:
          </p>
          <ul className="space-y-2 mb-8">
            <li className="text-gray-300">• <strong>Predictive Analytics:</strong> AI predicting which jobs you're most likely to get</li>
            <li className="text-gray-300">• <strong>Interview Preparation:</strong> AI-generated interview questions based on your CV</li>
            <li className="text-gray-300">• <strong>Salary Negotiation:</strong> AI-powered salary recommendations</li>
            <li className="text-gray-300">• <strong>Career Path Planning:</strong> AI suggesting optimal career moves</li>
          </ul>

          <h2 className="text-4xl font-black text-white mt-12 mb-6">Getting Started with AI CV Generation</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
