  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Pro Users Section */}
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg shadow-sm p-6 mb-8 border-2 border-purple-200">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {analytics.overview.proUsers} total Pro users • {analytics.overview.payingProUsers} paying customers
              </p>
            </div>
            <div className="text-right">
              <div className="text-3xl font-bold text-purple-600">
                £{analytics.overview.monthlyRecurringRevenue?.toFixed(2) || '0.00'}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="text-sm text-gray-600 mb-1">Monthly Pro</div>
              <div className="text-2xl font-bold text-purple-600">{analytics.overview.monthlyProUsers || 0}</div>
              <div className="text-xs text-gray-500">£{analytics.overview.monthlyProRevenue?.toFixed(2) || '0.00'}/mo</div>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="text-sm text-gray-600 mb-1">Annual Pro</div>
              <div className="text-2xl font-bold text-purple-600">{analytics.overview.annualProUsers || 0}</div>
              <div className="text-xs text-gray-500">£{analytics.overview.annualProRevenue?.toFixed(2) || '0.00'}/mo</div>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="text-sm text-gray-600 mb-1">Avg Revenue/User</div>
              <div className="text-2xl font-bold text-green-600">£{analytics.overview.averageRevenuePerProUser || '0.00'}</div>
              <div className="text-xs text-gray-500">Per paying customer</div>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="text-sm text-gray-600 mb-1">Projected ARR</div>
              <div className="text-2xl font-bold text-blue-600">£{analytics.overview.projectedAnnualRevenue?.toFixed(0) || '0'}</div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-lg overflow-hidden">
              ...
              <tbody>
                {analytics.users
                  .filter(user => user.plan === 'pro')
                  .sort((a, b) => b.generation_count - a.generation_count)
                  .map((user) => {
                    const daysSinceActive = user.last_activity 
                      ...
                      <tr key={user.id} className="border-b border-gray-100 hover:bg-purple-50">
                        ...
                        <td className="py-3 px-4">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                            {user.status === 'active' ? '👑 Pro Active' : '⚠️ Pro (Check Stripe)'}
                          </span>
                        </td>
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4">
                          <div className="text-sm font-semibold text-purple-600">{user.generation_count}</div>
                          <div className="text-xs text-gray-500">
                            {user.lifetime_usage} lifetime
                          </div>
                        </td>
                        <td className="py-3 px-4">
                          <div className="text-sm text-gray-900">{user.cv_count}</div>
                          <div className="text-xs text-gray-500">
                            {user.cover_letter_count} letters
                          </div>
                        </td>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            Top 10 Users by Generations (All Plans)
          </h3>
          <div className="overflow-x-auto">
