  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="prose prose-lg max-w-none">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Interview Preparation Guide 2026</h1>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">50 Most Common Interview Questions</h2>
          
          <div className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-3">1. Tell me about yourself</h3>
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-3">2. What are your greatest strengths?</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-3">3. What is your greatest weakness?</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-yellow-50 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-3">4. Why do you want to work here?</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-red-50 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-3">5. Where do you see yourself in 5 years?</h3>
              <p className="text-gray-700 mb-3">
          ...
          <div className="mt-8 bg-gray-50 p-6 rounded-lg">
            <h4 className="font-bold text-gray-900 mb-4">More Common Questions:</h4>
            <ul className="grid md:grid-cols-2 gap-3">
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Why are you leaving your current job?</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Describe a challenging situation you faced</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">How do you handle stress and pressure?</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">What are your salary expectations?</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Tell me about a time you failed</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">How do you prioritize your work?</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Describe your ideal work environment</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">What motivates you?</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        {/* STAR Method */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">The STAR Method for Behavioral Questions</h2>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className="font-bold text-gray-900 mb-3">STAR Method Example:</h4>
            <p className="text-gray-700 mb-2"><strong>Question:</strong> "Tell me about a time you had to meet a tight deadline."</p>
            <div className="space-y-3 mt-4">
              <p className="text-gray-700">
                <strong className="text-blue-600">Situation:</strong> "Our biggest client requested a complete website redesign with only 3 weeks notice before their product launch."
              </p>
              <p className="text-gray-700">
                <strong className="text-green-600">Task:</strong> "As the lead designer, I needed to deliver a fully functional, mobile-responsive site that met their brand guidelines and technical requirements."
              </p>
              <p className="text-gray-700">
                <strong className="text-purple-600">Action:</strong> "I immediately broke the project into daily milestones, delegated specific components to team members based on their strengths, and set up daily 15-minute standups to track progress. I personally handled the most complex features and worked evenings to ensure quality."
              </p>
              <p className="text-gray-700">
                <strong className="text-yellow-600">Result:</strong> "We delivered the site 2 days early. The client was thrilled, their product launch was successful, and they increased their contract value by 40%. This experience taught me the importance of clear communication and strategic delegation under pressure."
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Interview Preparation Checklist</h2>
          
          <div className="space-y-4">
            <div className="bg-white border-2 border-blue-200 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-4">1 Week Before</h3>
              <ul className="space-y-2">
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Research the company thoroughly (website, news, social media)</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Review the job description and match your experience to requirements</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Prepare 5-7 STAR stories covering different competencies</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Research your interviewers on LinkedIn</span>
                </li>
              </ul>
            </div>

            <div className="bg-white border-2 border-green-200 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-4">1 Day Before</h3>
              <ul className="space-y-2">
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Practice answers out loud (not just in your head)</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Prepare 3-5 thoughtful questions to ask the interviewer</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Choose and prepare your outfit</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Print multiple copies of your CV</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Plan your route and timing (arrive 10-15 minutes early)</span>
                </li>
              </ul>
            </div>

            <div className="bg-white border-2 border-purple-200 p-6 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-4">Day Of Interview</h3>
              <ul className="space-y-2">
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Eat a good breakfast and stay hydrated</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Review your key talking points</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Bring: CV copies, notepad, pen, portfolio (if relevant)</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Turn off phone notifications</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Practice power poses for 2 minutes before entering</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* Questions to Ask */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Smart Questions to Ask the Interviewer</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/cv-writing-guide" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-2 border-gray-200">
              <Target className="w-10 h-10 text-blue-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">CV Writing Guide</h3>
              <p className="text-gray-600 mb-4">Create a CV that gets you interviews.</p>
              <span className="text-blue-600 font-semibold">Read Guide →</span>
            </Link>
            <Link href="/cv-examples" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-2 border-gray-200">
            ...
            <Link href="/cover-letter" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-2 border-gray-200">
              ...
              <p className="text-gray-600 mb-4">AI-powered cover letter creation.</p>
              <span className="text-blue-600 font-semibold">Create Letter →</span>
            </Link>
          </div>
        </section>
      </div>
