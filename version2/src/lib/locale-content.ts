...
export const localeContent: Record<LocaleId, LocaleContent> = {
  es: {
    ...
    pricingBody: "Crea una cuenta gratis y adapta 1 CV al mes. Actualiza a Pro por 2,99 £/mes para generaciones ilimitadas, exportación DOCX y todas las herramientas.",
  ...
  fr: {
    ...
    pricingBody: "Créez un compte gratuit et adaptez 1 CV par mois. Passez à Pro pour 2,99 £/mois pour des générations illimitées, l'export DOCX et tous les outils.",
  ...
  de: {
    ...
    pricingBody: "Erstellen Sie ein kostenloses Konto und passen Sie 1 Lebenslauf pro Monat an. Upgraden Sie für 2,99 £/Monat auf Pro für unbegrenzte Generierungen, DOCX-Export und alle Werkzeuge.",
  ...
  pt: {
    ...
    pricingBody: "Crie uma conta grátis e adapte 1 currículo por mês. Atualize para o Pro por £2,99/mês para gerações ilimitadas, exportação DOCX e todas as ferramentas.",
  ...
  ar: {
    ...
    pricingBody: "أنشئ حسابًا مجانيًا وخصص سيرة ذاتية واحدة شهريًا. قم بالترقية إلى Pro مقابل 2.99 جنيه إسترليني شهريًا للحصول على عدد غير محدود من التخصيصات وتصدير DOCX وجميع الأدوات.",
  ...
  hi: {
    ...
    pricingBody: "एक मुफ़्त खाता बनाएं और हर महीने 1 रिज़्यूमे अनुकूलित करें। असीमित जनरेशन, DOCX एक्सपोर्ट और सभी टूल के लिए £2.99/महीने में Pro में अपग्रेड करें।",
